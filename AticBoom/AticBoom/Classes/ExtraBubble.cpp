...
namespace aticboom {
    ...
    ExtraBubble::ExtraBubble(Json::Value bubble, int world) : ExtraBubble::GameObject(bubble, world){
    ...
    void ExtraBubble::initAnimations() {
        CCSprite* pSprite = CCSprite::spriteWithSpriteFrameName("pw-bubble.png");
        this->addChild(pSprite, 1, EXTRA_BUBBLE_SPRITE_TAG);
    }
    
    void ExtraBubble::hide() {
